...
pub enum ArgumentKind {
    ...
    MenuInput {
        ...
        menu_field: IString,
        is_primitive: bool,
        dynamic_menu_input_kind: Option<DynamicMenuInputKind>,
    },
}

#[derive(Debug, Clone, Copy, PartialEq, Serialize, Deserialize)]
pub enum DynamicMenuInputKind {
    Costume,
    Backdrop,
    Sound,
    Target,
        ...
        "motion_goto" => BlockKindInfo {
            arguments: vec![Argument {
                ...
                kind: ArgumentKind::MenuInput {
                    ...
                    is_primitive: false,
                    dynamic_menu_input_kind: Some(DynamicMenuInputKind::Target),
                },
                ignore: false,
            }],
            block_category: MOTION_CATEGORY.clone(),
        ...
        "looks_switchcostumeto" => BlockKindInfo {
            arguments: vec![Argument {
                ...
                kind: ArgumentKind::MenuInput {
                    ...
                    is_primitive: false,
                    dynamic_menu_input_kind: Some(DynamicMenuInputKind::Costume),
                },
                ignore: false,
            }],
            block_category: LOOKS_CATEGORY.clone(),
        ...
        "looks_switchbackdropto" => BlockKindInfo {
            arguments: vec![Argument {
                ...
                kind: ArgumentKind::MenuInput {
                    ...
                    is_primitive: false,
                    dynamic_menu_input_kind: Some(DynamicMenuInputKind::Backdrop),
                },
                ignore: false,
            }],
            block_category: LOOKS_CATEGORY.clone(),
        ...
        "sound_playuntildone" => BlockKindInfo {
            arguments: vec![Argument {
                ...
                kind: ArgumentKind::MenuInput {
                    ...
                    is_primitive: false,
                    dynamic_menu_input_kind: Some(DynamicMenuInputKind::Sound),
                },
                ignore: false,
            }],
