                ...
                emit_message_eager(
                    ...
                    GrazeSourceMessage::Warning(
                        GrazeSourceWarning::Specific(
                            GrazeSourceWarningKind::CallableAsInput,
                            source_span,
                        ),
                        None,
                    ),
        ...
        match self {
            ...
            KnownBlock::BlockRef { id: _ } => {
                emit_message_eager(
                    ...
                    GrazeSourceMessage::Warning(
                        GrazeSourceWarning::Specific(
                            GrazeSourceWarningKind::BlockRefAsField,
                            source_span,
                        ),
                        None,
                    ),
            ...
            | KnownBlock::BoundMethod { .. } => {
                emit_message_eager(
                    ...
                    GrazeSourceMessage::Warning(
                        GrazeSourceWarning::Specific(
                            GrazeSourceWarningKind::CallableAsField,
                            source_span,
                        ),
                        None,
                    ),
            ...
            KnownBlock::Empty => {
                emit_message_eager(
                    ...
                    GrazeSourceMessage::Warning(
                        GrazeSourceWarning::Specific(
                            GrazeSourceWarningKind::EmptyExpressionAsField,
                            source_span,
                        ),
                        None,
                    ),
            ...
            KnownBlock::SingletonReporter {
                ...
                if let Some(value) = field {
                    ...
                    emit_message_eager(
                        ...
                        GrazeSourceMessage::Warning(
                            GrazeSourceWarning::Specific(
                                GrazeSourceWarningKind::NonFieldSingletonAsField,
                                source_span,
                            ),
                            None,
                        ),
            ...
            KnownBlock::SingletonReporter {
                    ...
                    && bind_info.parent_target.as_str() != target.get_field_value()
                {
                    emit_message_eager(
                        ...
                        GrazeSourceMessage::Warning(
                            GrazeSourceWarning::Specific(
                                GrazeSourceWarningKind::AssignPropertyOfOtherTarget,
                                source_span,
                            ),
                            None,
                        ),
